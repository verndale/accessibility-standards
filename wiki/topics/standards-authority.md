...
Related: [semantic and pattern model](./semantic-pattern-model.md), [consumer projections](./consumer-projections.md), the [original delivery plan](../plans/2026-08-30-shared-accessibility-standards-delivery.md), and the [WCAG 2.2 expansion plan](../plans/2026-08-30-wcag-2-2-coverage-and-pattern-expansion-9afa9d1d04.md).
